...
/**
 * file: Orders-oo.php
 * reason: Executes all functions of the online shopping
 *         application. The name of the submit button is checked to determine * which part of the program is to be executed,
 *         which part of the program is to be executed.
 */
