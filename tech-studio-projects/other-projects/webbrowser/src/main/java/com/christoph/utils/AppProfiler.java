package com.christoph.utils;

import org.apache.jmeter.samplers.SampleResult; // Import SampleResult to log results
import org.apache.jmeter.samplers.SampleEvent; // Import SampleEvent for events
...
public class AppProfiler {
    ...
    public long stop() {
        ...
        sampleResult.setEndTime(System.currentTimeMillis()); // Set the end time
